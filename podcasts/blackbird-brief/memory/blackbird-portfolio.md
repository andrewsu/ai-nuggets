...
Structured reference for **The Blackbird Brief** (`podcasts/blackbird-brief/`).
Defines what "portfolio-relevant" means and lists the people, programs,
targets, institutions, and competitors to track.

**How to maintain this file — edit in place.** When a run learns something new
and durable about a program, partner, or competitor, revise the relevant entry
below and bump that entry's `_Last update:_` line. Do **NOT** append dated run
entries, daily logs, "Last verified" blocks, or episode recaps to this file.
Per-episode narrative already lives in `podcasts/blackbird-brief/scripts/`;
per-item deduplication lives in `podcasts/blackbird-brief/state/shipped.jsonl`.

_Compiled from public sources (press releases, BioBuzz, Technical.ly, UM
Ventures, company sites, PubMed, bioRxiv/medRxiv COI disclosures, Google
Patents). Items marked ⚠ need confirmation; ✅ = confirmed._
...
https://www.biospace.com/deals/pfizer-punts-seagen-adc-further-muddying-value-of-the-43b-buyout
  ...
  - **THE THREE QUESTIONS THAT DECIDE WHETHER A SURFACE ANTIGEN IS BUILDABLE — ALL ANSWERABLE FROM A DATABASE BEFORE ANYONE MAKES A CONJUGATE (added 2026-09-14 Portfolio Watch item 2; presented 2026-09-13, IASLC WCLC 2026, Seoul, 09-12 → 09-15).**
    ...
    **Q2 — IS IT GENOTYPE-DEPENDENT?** Consistent across tumours with and without **KRAS G12C, ALK, MET** alterations.
    **Q3 — IS IT PROGNOSTIC?** **No.** Not independently associated with OS or PFS; outcomes tracked performance status and extent of prior therapy ⇒ behaves as a **target-engagement marker, not a prognostic confounder**, so response in a high expresser is attributable to the drug.
    **CANDID LIMIT WHITEHAWK DID NOT LEAD WITH: PTK7-low tumours were enriched for KEAP1 and STK11 alterations** — the IO-refractory, poor-prognosis subsets. **The target is dimmest exactly where the unmet need is greatest**, which is a real constraint sitting in their own data.
    **STANDING CHECKLIST (Avi Khanna + Eddie Cherok): run Q1–Q3 on every antigen this theme considers.** An antigen that fails Q1 yields a drug that stops working in the second-line population it was designed for. **SECOND READ: a Phase 1 company bought differentiation against three later-stage rivals from a clinico-genomic database partnership — no patients, no sites, no protocol.** Affordable way to put a target's durability on the record before corp dev asks; pairs with the standing screen on divested large-pharma assets opened above. Sources:
    https://www.prnewswire.com/news-releases/whitehawk-therapeutics-presents-real-world-analyses-supporting-ptk7-as-a-durable-adc-target-in-egfr-wild-type-non-small-cell-lung-cancer-at-wclc-2026-302876813.html ·
    https://www.biospace.com/press-releases/whitehawk-therapeutics-presents-real-world-analyses-supporting-ptk7-as-a-durable-adc-target-in-egfr-wild-type-non-small-cell-lung-cancer-at-wclc-2026
...
- **THE RESIDUAL A GENETIC MEDICINE LEAVES BEHIND IS ITSELF AN APPROVABLE MARKET — AND THE BINDING CONSTRAINT IS THE INSTRUMENT, NOT THE BIOLOGY (added 2026-09-14 Portfolio Watch LEAD; approved 2026-09-13).**
  ...
  **READ (Matt Tremblay + Geoff Lynn).** SMN-directed therapy has been available since 2016. A decade on, the **residual functional deficit in TREATED patients was large enough, durable enough and MEASURABLE enough to support a second approved product with its own pivotal.** The genetic fix moved the gap; it did not close it. **Assume the same in congenital hearing loss — the evidence is already in hand: Otarmeni reported 80% of evaluable patients with IMPROVED hearing, not normal hearing.** The residual in hearing is **speech perception in noise / auditory processing**, which a threshold-based approval never has to demonstrate, and it is unnamed, unpriced and unowned.
  **THE HARD HALF — THE INSTRUMENT, AND IT IS A PRE-IND ITEM.** Scholar Rock had **HFMSE**: a validated, granular functional scale sensitive enough to register a **2.2-point increment on top of a genetic medicine in 188 patients**. **ACTION: identify the hearing-loss equivalent. If it does not exist, developing one goes into the pre-IND ask alongside the external-control-SOURCE question logged 2026-09-04 (uniQure/AMT-130). You cannot sell into a residual you cannot measure.** Source:
  https://www.biospace.com/press-releases/scholar-rock-announces-fda-approval-of-isembyld-apitegromab-mstn-the-first-and-only-muscle-targeted-treatment-for-children-and-adults-with-spinal-muscular-atrophy-sma
...
- **THE FIELD SORTS BY *SETTING*, NOT BY PLATFORM — AND THE SORT FAVOURS ADVENTRIS'S BOARD (added 2026-09-14 Portfolio Watch item 3; published 2026-09-14).**
  Field scorecard across five challengers to Merck/Moderna: **Roche/BioNTech autogene cevumeran** (personalised mRNA neoantigen) — Phase 1 pancreatic, **7 of 8 responders alive 4–6 years post-surgery vs a 13% five-year baseline**, while **Phase 2 colorectal (IMcode) was halted for futility August 2026**; **BioNTech BNT113** (HPV16; Phase 2/3 AHEAD-MERIT, 40% response at 12 months with Keytruda) and **BNT116** (six NSCLC antigens with Libtayo; 10% PR, 70% SD in 20 patients); **OSE Tedopi** (off-the-shelf T-cell epitope; Phase 3 Artemia data late 2027); **Elicio ELI-002** (KRAS peptide + adjuvant) — **missed its Phase 2 primary June 2026**, biomarker analysis found benefit in **completely resected** tumours, **advancing to Phase 3 in that subset ONLY**; **Agenus BOT+BAL** — 0% response in gastroesophageal (April 2026).
  **THE SORT (Eddie Cherok): every positive signal in that list is in RESECTED or EARLY disease; every clean failure is in ESTABLISHED or METASTATIC disease.** Colorectal autogene failed, post-surgery pancreatic did not; Elicio failed overall and survived in the resected subset; the Merck/Moderna Phase 3 win was **adjuvant** melanoma. ⇒ **The modality is not failing — it is failing in metastatic disease, which is where most of the capital went.** Adventris's differentiated Phase 1 is **interception** (20 hereditary-PDAC-predisposed individuals, radiographic lesion, no cancer, **vaccine alone, no checkpoint**; 90% mKRAS T-cell response; cyst reduction/resolution ~38% vs ~7%). **The field's own failure pattern now argues for their setting** — carry that into the still-open ownership conversation.
  **THE SUBSTRATE — mRNA HAS ITS FOOTING BACK, WHICH MATTERS BECAUSE THEIR DELIVERY ARM IS RNA.** ~**$500M of BARDA mRNA contracts terminated August 2025**; **FDA approved Moderna's mFLUVISA 2026-08-05**, one year to the day; **Merck/Moderna intismeran autogene + Keytruda positive Phase 3 in melanoma (INTerpath-001, n=1,137, randomised 2:1)**; offsetting, BioNTech's 08-28 CRC discontinuation. **Jeff Coller (Johns Hopkins)**: the momentum *"really underscores the promise of the technology and reinvigorates the space."* ⇒ **Adventris's trans-amplifying RNA vector and the Mao lab LNP platform (§2b) are both materially more fundable than 18 months ago.** Sources:
  https://www.biospace.com/drug-development/5-drugmakers-chasing-merck-and-moderna-in-the-cancer-vaccine-race ·
  https://www.biospace.com/drug-development/after-a-brief-storm-of-political-headwinds-mrna-is-back-with-strong-momentum
...
- **THE FDA IS CODIFYING THE EXPENSIVE PART OF PSYCHEDELIC THERAPEUTICS, AND A PERIPHERAL ASSET WOULD NOT CARRY IT — AN OPEN COMMENT DOCKET UNTIL 2026-10-05 (added 2026-09-14 Portfolio Watch item 4; hearing 2026-09-14).**
  **FDA public hearing, "Considerations for Potential Future Therapeutic Use of Psychedelic Drugs," 2026-09-14, 12:30–16:30 ET, White Oak Campus Bldg 31, Silver Spring MD** (+ webcast) — **~35 miles from Baltimore.** Implements **Executive Order 14401, "Accelerating Medical Treatments for Serious Mental Illness" (2026-04-18)**; follows the agency **finalising its psychedelic clinical-trial guidance in July 2026**. Agenda: **provider training, patient safety protocols, access, data-collection standards, manufacturing and distribution**, all framed around **"supervised and supportive settings."** **Written comments close 2026-10-05.**
  Context in the room: **Compass Pathways COMP360** (psilocybin, depression) decision expected end-2026 / early-2027, analysts 75–85% confident off July Phase 3 durability data; **Definium Therapeutics (Nasdaq: DFTX) DT120**, oral lysergide ODT — **topline Phase 3 Panorama in GAD 2026-09-14**: **n=245**, ~32 centres, randomised **2:1:2** to 100 µg / 50 µg / placebo, primary = **change from baseline in HAM-A total at Week 12**, 12-week double-blind + 40-week OLE. Comparator economics: J&J's Spravato **$584M in Q2**. Note also that new permanent **CDER director Michael Davis** was previously **CMO at Usona Institute**.
  **READ (Jon Robbins + Hemaka Rajapakse) — SHARPENS THE 2026-09-06 ITEM IN OUR FAVOUR.** 09-06 logged that psychedelic capital has gone **entirely** to psychiatry (AbbVie/Gilgamesh $1.2B, Otsuka/Transcend $700M, Lilly/AtaiBeckley $2.8B) and **nobody is bidding for peripheral 5-HT2A**. What the agency is now codifying is a **COST STRUCTURE** — supervised setting, trained provider, monitored administration — **bolted permanently onto every psychiatric psychedelic. A peripherally acting, non-hallucinogenic asset dosed once before chemotherapy carries none of it**, and that delta is about to be written into federal guidance rather than merely argued. **ACTION: the docket is open until 2026-10-05 — this is the cheapest opportunity we will get to put the non-opioid-pain framing on the federal record.** Sources:
  https://www.biospace.com/fda/psychedelic-therapies-ride-wave-of-public-favor-into-fda-hearing ·
  https://www.fda.gov/news-events/fda-meetings-conferences-and-workshops/considerations-potential-future-therapeutic-use-psychedelic-drugs-public-hearing-09142026 ·
...
- **THE SUBSTANTIAL-EVIDENCE FRAMEWORK OUR PRE-IND PROGRAMMES ARE BEING DESIGNED AGAINST IS IN REDRAFT, AND IT PRICES MECHANISTIC CONFIDENCE IN ALPHA (added 2026-09-26; Hemaka Rajapakse + Anthony Accorsi + Jon Robbins + Yixuan Qiu).** FDA revised draft guidance *Demonstrating Substantial Evidence of Effectiveness for Human Drug and Biological Products* (CDER+CBER+OCE, June 2026, Rev 1), **Docket FDA-2019-D-4964**; comments closed **2026-09-22**; final pending. **TWO DOORS. Door 1 — one adequate and well-controlled trial + a source of STRONG confirmatory evidence**, which FDA generally expects from **related controlled trial data (a related disease/condition or a related product) or from other approved drugs in the SAME PHARMACOLOGICAL CLASS**, with closeness judged on similarity of **pathophysiology, mechanism of action and endpoints**. **Door 2 — a single HIGHLY PERSUASIVE trial** whose already-completed early-phase work supplies the confirmation, subject to a checklist (generalizable US-relevant multi-site design with SoC control; clinically meaningful primary endpoint, irreversible morbidity/mortality given as the example; supportive DISTINCT prespecified secondaries; consistency across important subgroups; comprehensive follow-up, minimal missing data). **THE LOAD-BEARING CLAUSE, verbatim: "The appropriate significance level will depend on the prior (i.e., pretrial) probability of the drug being effective; in cases where the prior probability of effectiveness is low (e.g., because the disease pathophysiology and drug mechanism are not well understood), a single trial with hypothesis testing at the common one-sided 0.025 significance level may not adequately limit the probability of false positive effectiveness conclusions."** ⇒ **Mechanistic confidence now sets alpha and therefore n. ALETIRA (monogenic loss-of-function) sits at a HIGH prior. GPR52 sits at a LOW one and ALSO cannot use Door 1, because there is no approved GPR52-agonist class to borrow from — so the neuropsych NewCo should plan for a highly-persuasive trial or two trials and say so in the DC narrative.** **TIMING: the draft says the one-trial-plus-confirmatory-evidence approach "should be discussed with FDA PRIOR TO INITIATING the single trial" — not at end-of-Phase-2.** **WHAT THE RECORD ASKS FOR: Ultragenyx (six rare-disease approvals since 2017) wants FDA to NAME AN INTERNAL BASELINE CONTROL (within-patient comparison / run-in period), which the draft omits while recognising external historical controls, and warns that without it capital concentrates on diseases with comprehensive natural history or populations large enough to randomise — that is the Aletira pre-IND ask in a better-credentialed letterhead, and ABR thresholds are machine-measured, per-ear, with an untreated ear available as its own control. PhRMA asks FDA to DEFINE "strong confirmatory evidence," "early-phase confirmatory evidence," "closely related indications" and "same pharmacological class" — precisely the terms a PLATFORM relies on for indication two (live planning risk for SELEXON). argenx wants RWE, expanded-access data, shared MoA and validated targets spelled out. COUNTERWEIGHT: PORTAL (Brigham/Harvard, Kesselheim) wants mechanistic evidence to confirm only when strongly linked to clinical outcomes, no presumption that small effects are meaningful from the endpoint alone, and postmarketing studies begun before approval with consequences for non-completion (their number: 37% of Phase 3s behind initial FDA cancer approvals 2018-2025 gave low clinical benefit). Expect the final between PhRMA and PORTAL.** **ACTIONS: (1) rewrite the NuGate/Aletira endpoint split against the Door-2 checklist rather than intuition (merges with the Encoded/Angelman item below); (2) confirm the Aletira pre-IND ask is framed as a Door-1-or-Door-2 declaration made BEFORE the pivotal; (3) add the prior-probability clause to the GPR52 DC package alongside the signalling-bias and biomarker-instrument items.** Sources: https://www.fda.gov/media/133660/download · https://www.regulations.gov/docket/FDA-2019-D-4964 · https://www.federalregister.gov/documents/2026/06/24/2026-12622/demonstrating-substantial-evidence-of-effectiveness-for-human-drug-and-biological-products-revised
...
- **CERVINO — HALF RESOLVED 2026-09-25 at the IMS Glasgow plenary; the half that matters is still open (added 2026-09-05; Jon Robbins).** **RESOLVED:** arm-level denominators published — **n=393 randomised ~1:1 (196 vs 197), median 3 prior lines, median follow-up 11.4 months; ORR 74.0% vs 45.7% (p<0.0001); PFS HR 0.40 (0.29–0.54); 12-month OS 87.9% vs 72.0% (HR 0.48, nominal p=0.0012, efficacy boundary NOT crossed); CRS 28.3% among SINGLE-step-up patients, predominantly grade 1, ZERO grade ≥3; one grade-1 ICANS; grade 3/4 infections 27.7% vs 19.2%, grade 5 1.5% vs 3.1%; TEAE discontinuations 3.6% vs 9.6%**; dosing is one step-up then Q4W. The 09-05 caveat ("directional until Glasgow") is discharged — **these numbers are TPP-grade now.** **STILL OPEN: no target-density or BCMA-expression analysis has been reported, so whether the avidity-for-affinity trade travels to a lower-density or heterogeneously expressed antigen remains unevidenced — that is the assumption the whole Winnow control-architecture row borrows.** Ask AbbVie or read the eventual full publication.
...
- **Winnow control-architecture row, evidenced (added 2026-09-02):** assemble the actual comparison behind the new TPP row — IEC-HS and CRS incidence and grade distribution for autoimmune CD19 CAR-T (rap-cel, zola-cel, Cabaletta, Kyverna) against the published HLH/CRS rates for CD3 bispecifics (blinatumomab as the worst case). The claim we can defend is dose control, and it needs numbers behind it before an investor asks. (Jon Robbins + Eddie.)
  - **ADD A DURABILITY-AND-LATE-TOXICITY COLUMN — BOTH SIDES WERE PRICED ON THE SAME GLASGOW STAGE ON THE SAME AFTERNOON (updated 2026-09-25; IMS 2026).** **Legend/J&J CARVYKTI (cilta-cel), CARTITUDE-2 Cohort A (Abstract PA-288): n=20, 1–3 prior lines, median follow-up 60.7 months — 10/20 (50%) ALIVE AND PROGRESSION-FREE WITH NO FURTHER ANTI-MYELOMA TREATMENT at ≥5 years; median PFS 60.5 months; median OS not reached; 5-year OS 69.2%. Since the ~29–30-month cut: ONE NEW HEMATOLOGIC MALIGNANCY (AML) and two deaths (one progression, one breast cancer), neither deemed product-related; seven deaths total in the study, ONE considered cilta-cel-related.** Label carries a **boxed warning covering CRS, neurologic toxicity AND secondary hematologic malignancies**; RBC (Sept 9 note) reads the product as **"more suitable for a younger and higher risk population"** given the toxicity balance. **⇒ THE TRADE, STATED: one infusion buys a treatment-free tail no engager has demonstrated; the price is a late-toxicity profile a DYING myeloma patient accepts and a NON-DYING autoimmune patient does not. This is the affirmative case for dose-controlled redirection in autoimmunity — use it alongside, not against, the Kyverna 12-month data. CANDID LIMIT: n=20; 50% on twenty patients is a hypothesis, not a rate.** Sources: https://www.biospace.com/press-releases/legend-biotech-presents-carvykti-data-showing-half-of-patients-with-rrmm-remained-progression-free-and-alive-five-years-after-a-single-infusion · https://www.biospace.com/drug-development/j-j-legend-tout-long-term-survival-benefits-for-carvykti-in-multiple-myeloma
