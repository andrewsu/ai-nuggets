...
_Last verified: 2026-08-18 (Tuesday — Portfolio Watch only). **LEAD = a CATCH-UP MISS, corrected: Skylark Bio dosed the first patient in SONIX (Phase 1/2, SKY-GJB2) on 2026-08-11 — a competitor now CLINICAL in ALETIRA'S lead indication, using ALETIRA'S OWN ARCHITECTURE.** Our 08-11/08-12 sweeps missed it; aired 08-18 as an explicit catch-up. SKY-GJB2 = single unilateral INTRACOCHLEAR injection pairing an **engineered AAV capsid designed for BROAD TRANSDUCTION** with **"cell-specific expression control"** to deliver functional GJB2 (connexin 26, a gap-junction protein) to the cochlear **SUPPORTING CELLS** that natively express it, rebuilding the gap-junction network. That two-part split (broad vector + restricted expression) IS the SELEXON premise, now in a child. Trial: open-label multicenter, ages 9 months–7 years, safety/tolerability/PK/PD/preliminary efficacy, NCT07627971 (sonixstudy.com); **preliminary data guided YEAR-END 2026**, more 2027. Company: Cambridge MA, out of stealth 08-11; CEO **Jodi Cook, PhD**; scientific advisor **Daniel Lee, MD FACS**; pipeline also SKY-PEN (SLC26A4/Pendred) + undisclosed CNS. Funding/investors NOT disclosed. Target size: GJB2 = **most common genetic cause of non-syndromic deafness, ~200,000+ people US+EU**, no approved causal therapy; STAT called it the **"holy grail"** of hearing-loss targets. **THREE READS (as aired): (1) VALIDATION, uncomfortably precise** — a clinical-stage company bet a FIH program on exactly our division of labor, so "expression control is the differentiating layer" may get clinical proof on someone else's dime; belongs in Geoff Lynn's Series A deck as a field-convergence slide BEFORE an investor raises it. **(2) COMPETITIVE — the hearing-loss gene-therapy field has CONSOLIDATED ONTO GJB2.** Otoferlin is spoken for (Regeneron **Otarmeni** accelerated approval 2026-04-23, first gene therapy through the national priority voucher program, ~50 US babies/yr) and **Sensorion DISCONTINUED SENS-501/OTOF in June 2026 and named its GJB2 candidate SENS-601 lead**. So small beachhead taken; big target now has a clinical-stage first mover PLUS a funded European fast-follower. If hereditary hearing loss remains Aletira's lead indication signal, that lane got materially more crowded. **(3) TECHNICAL / OPEN DILIGENCE QUESTION (Avi + Hugh Wells, this week):** connexin 26 must land in SUPPORTING cells, NOT hair cells, and at roughly the right LEVEL — gap junctions are dose-sensitive, and overexpressing a connexin in the wrong cochlear cell is its own toxicity = the sharpest use case for splicing-based expression restriction in the ear. **Skylark says "cell-specific expression control" but has NOT disclosed the mechanism.** If it is a cell-type-specific PROMOTER → we have a real differentiation story (RNA-level fidelity, smaller cassette). If they have FILED ON SPLICING-BASED control → must know BEFORE the raise. **ACTION: pull the SONIX protocol + Skylark patent estate.** **SECOND ITEM (fresh, in-window 2026-08-14) = CAPRICOR, and it REFRAMES our standing Aletira read.** Stock **+68% to $6.95** after CEO Linda Marbán said Capricor will amend the **deramiocel** BLA (cardiosphere-derived cell therapy, DMD) with **24-month HOPE-3 open-label extension data** plus new analyses, **NARROWING the indication to the primary endpoint it actually hit — upper-limb function (PUL 2.0, 54% slowing vs placebo, p=0.03)**; FDA "indicated it is willing to review this amendment and upon receipt to extend the PDUFA action date accordingly" (standing PDUFA was 08-22). Context: **07-30 adcomm voted 9–3 AGAINST effectiveness** on a cardiac claim whose statistics FDA itself disputed; Lancet publication showed the LVEF secondary no longer significant. **THE REFRAME (a self-correction to this brief's framing, aired):** we have been casting the Ultragenyx date as a read on whether the post-Elevidys SAFETY bar ratcheted UP. True but HALF the picture. Capricor shows an agency **RIGOROUS ON EVIDENCE, FLEXIBLE ON PATH** — holds you to what your statistics support, will NOT treat an adcomm vote as the end of the conversation if you narrow the claim to what you proved. Consistent with post-turnover posture (Prasad out of CBER ~late April 2026, Makary out ~mid-May, **Kyle Diamantas acting commissioner**; BioSpace 07-08: rare-disease stance moved "from adversarial to partnership"; note CBER leadership itself remains UNVERIFIED — do not assert a current CBER director). **WHY IT IS A BETTER RAISE ARGUMENT (durable, use this going forward): an agency that rewards NARROWING rewards PRECISION.** A platform whose proposition is restricting EXPRESSION to the cells that need it is selling into a regulator currently rewarding sponsors for restricting CLAIMS to the patients they can prove — same instinct, one layer down. Stronger + more durable for Hemaka/Eddie than "the bar went up, so selectivity matters more." **CALENDAR CORRECTION (durable — the 08-16 entry said "SAT AUG 23", which is WRONG): 2026-08-23 is a SUNDAY and Capricor's 08-22 is a SATURDAY.** FDA does not act on weekends → **Ultragenyx DTX401 realistically prints FRI 08-21 or MON 08-24**, possibly the SAME DAY as the 1104health OIG filing. Staff a heavy Monday. (Also: Ultragenyx **UX111**/Sanfilippo A PDUFA **2026-09-19**; BofA models US price $2M, ~$796M peak risk-adjusted GSDIa sales.) **1104HEALTH (fresh — docket audited directly via regulations.gov v4 API, the clean way to do this): HHS OIG RFI docket HHSIG-2026-0034, commentEndDate 2026-08-25T03:59:59Z = MON AUG 24 11:59pm ET, NOT extended, `allowLateComments: false`. TOTAL COMMENTS = EIGHT, and NOT ONE from a trade association or major sponsor** (clusters 07-01 ×3, 07-30 ×3, 08-10 ×1; the only in-window filing is **HHSIG-2026-0034-0009, posted 08-14**, a private individual in Maryland addressing RFI Qs 2/4/6/10/11/12/14). **So-what: this flips from COMPLIANCE to LEVERAGE** — on a nearly empty docket, a specific data-grounded comment from an operator who actually moves patients into trials carries disproportionate weight, and there is NO basis for assuming the big trade groups carry the argument. Action (Rose Wang): file early enough to be READ. First OIG official on record = **Spencer Turnbull** (chief, industry guidance branch), Federal News Network 08-12. Adjacent (08-13, 1 day OOW, never aired): **Sarah Cannon Research Institute + Merck** collaboration deploying SCRI's **Accelero** model to run Merck oncology studies at US community sites = sponsor money moving into community-site trial delivery, i.e. 1104health's thesis. Also in-window: FR 91 FR 53262 (08-17) IND paperwork notice inviting comment on an **IND pilot program** (OMB 0910-0014, docket FDA-2026-N-1736, comments due 09-16); PDUFA VIII reauthorization meeting/comment request (08-14). **SCHIZOPHRENIA NEWCO (Lieber + Third Rock): ZERO GPR52 news in-window** — Nxera STILL has not named a buyer for NXE'149 (last events: Boehringer option decline 2025-12-19; Nxera Q2 08-07 carried NO GPR52 partner news); PubMed "GPR52" entry-date 08-01→08-18 = **0 records**; Lieber newsroom silent since 07-21. **BUT A NEW MECHANISM ARRIVED (in-window, 08-17): Leal Therapeutics closed a $30M Series A EXTENSION with ELI LILLY as a NEW investor** (alongside OrbiMed, Newpath, Euclidean, SV Health Dementia Discovery Fund, Chugai Venture Fund, Alexandria, PhiFund) **and started a Phase 1b/2a of LTX-001 in schizophrenia** — an oral, brain-penetrant **GLS1 / mitochondrial GLUTAMINASE inhibitor**, a metabolic glutamate-side mechanism that is NEITHER dopaminergic NOR muscarinic = a **THIRD mechanistic wave**. NCT07734493, n≈90, RECRUITING, acute exacerbation of schizophrenia, QD+BID arms vs placebo, endpoints through Day 42, **initial data guided year-end 2026**; protocol carries a **full ocular safety battery (BCVA, fundus photography, FAF, OCT, slit lamp)** consistent with known retinal liability for glutaminase inhibition. Also funds LTX-002 ALS cohorts. **So-what (Hemaka, as aired): Lilly funding a third wave says large-pharma appetite in schizophrenia is still WIDE OPEN (good for partnering), BUT by the time our DC is declared later in 2026 a competitor will have HUMAN DATA in a novel non-dopaminergic mechanism. Does NOT threaten our cognitive/negative-symptom differentiation (still the whole argument) — but "novel mechanism" is getting LESS SCARCE, so the DC package must lead with THREE-DOMAIN data, not novelty.** **aSKY (landscape, 2026-08-17 — the PAIRING is the lesson, use this framing): AstraZeneca published two opposite results the SAME DAY and the variable is PATIENT SELECTION.** (a) **SAFFRON WIN**: Tagrisso + **savolitinib** (selective MET TKI) beat platinum-doublet chemo on **BOTH PFS and OS** in EGFRm NSCLC progressing on Tagrisso with **high MET overexpression/amplification, PROSPECTIVELY selected by IHC + FISH** — 338 pts, 230 centres, 29 countries, savolitinib 300mg BID + osimertinib 80mg QD; safety consistent, no new signals; **~34% of tumours take the MET resistance route after a 3rd-gen EGFR TKI**; already approved in China, temporary authorisation Switzerland; no HRs disclosed. (b) **DISCONTINUATION**: eVOLVE-Lung02 killed — **volrustomig** (PD-1/CTLA-4 bispecific) 1L metastatic NSCLC **PD-L1 <50%**, n=895, vs pembrolizumab+chemo, stopped when an independent DMC judged it unlikely to hit EITHER co-primary (PFS or OS); volrustomig continues in mesothelioma/cervical/HNSCC. **So-what: NSCLC value is CREATED in prospectively selected molecular niches and DESTROYED in broad ones → aSKY's undisclosed mechanism is now a TRIAL-DESIGN problem, not just a competitive-intelligence one.** If the antibody has no companion SELECTION hypothesis the team can name, it is being built for the side of the ledger that just lost. Action (Krupnick + Eddie): answer on ONE slide — which patients, by what assay. **NO-CHANGE LINES (aired one line each, no re-coverage):** Clasp — no update; latest is **07-24 Clinical Cancer Research** publication of CLSP-1025 preclinical data ("first clinical-stage TCE targeting an intracellular driver mutation"); p53 GUARDIAN-101 Ph1 readout still expected this year via Third Rock seat; CLSP-5282 (KRAS G12V / HLA-A*03:01) IND planned 2026. RNA translation-activator — nothing new since the 08-17 CAMP4 read; **Sept 28 analyst day** on the calendar. Gut-restricted GCPII/IBD — **nothing in window at all**; BioSpace IBD channel's most recent story is 06-23. **Nothing-fresh-in-window per sweep (avoid re-chasing):** Ultragenyx DTX401 (NO news; Aug 23 is a standing calendar item, BLA accepted 02-23); Skylark = 08-11 (aired late, now logged); Sensorion SENS-601 (06-09); Otarmeni approval (04-23); RevMed Q2 (08-05); Erasca Q2 (08-11); Kura Q2 (08-12); GSK/Nuvalent zidesamtinib approval + neladalkib PDUFA 11-27 (07-22); Roche divarasib Krascendo-1 (07-01/02); BMS Krazati KRYSTAL-10 CRC miss (**07-07** — beware bioxconomy.com re-datelining it 08-17); Summit/Akeso ivonescimab China squamous approval 08-12 + PFS degradation analysis 08-17 (off-thesis, PD-1/VEGF); Amgen EU pulls Tavneos on GCP breach 08-14 (off-mechanism, credibility item only); J&J returns prizlon-cel to AbelZeta 08-17 (CAR-T, not pHLA); Abivax obefazimod pre-NDA (07-30); Merck tulisokibart ATLAS-UC (06-22); CAMP4 Q2 (08-13, aired 08-17 — beware Manila Times 08-14 re-dateline); Stoke Q2 (08-03); Ractigen $31M saRNA/RNA-activation raise (07-29, closest upregulation-platform comparator); Cobenfy Q2 $63M ~4% miss (~08-10); MapLight ZEPHYR (07-27); LB Pharma Q2 (08-11); Minerva Q2 (08-07); Sanofi cuts 229 at Blueprint (08-17, off-thesis); BioBuzz BHCR roundup 08-13 (1 day OOW; BioBuzz published NOTHING 08-14→08-18). **BLACKBIRD DIRECT: ZERO in-window mentions** of Blackbird Laboratories/BioVentures/BioHub, Tremblay, Cherok, Aletira, Geoffrey Lynn, aSKY, Adventris, Islex, Clasp, or the Bisciotti Foundation. blackbirdlab.org/news is STALE (newest item 2025-07-24); JHTV + FDA newsroom 403 to fetching; UM Ventures newsletter is Winter/Spring 2026. **DURABLE TOOLING NOTES (update [[reference_biotech_news_source_access]]):** BioSpace index pages (`/news`, `/press-releases`, `/fda`, `/neuroscience`, `/policy`, `/biospace-layoff-tracker`) are BY FAR the highest-yield dated index and fetch cleanly; **Fierce PHARMA article pages fetch, Fierce BIOTECH 403s** (even via r.jina.ai); Endpoints/STAT/JHTV/FDA-newsroom/Businesswire 403; **regulations.gov HTML 403s but the v4 API with DEMO_KEY works and is the right way to audit an RFI docket** (comment end dates, per-comment posted dates); Federal Register API + ClinicalTrials.gov v2 API both clean; astrazeneca.com press releases 403 (use stocktitan mirror); ir.ultragenyx.com + ir.revmed.com TIME OUT at 60s (use GlobeNewswire / individual news-release-details URLs); IR pages for Nxera/Ionis/Stoke/CAMP4 are client-side rendered and yield nothing. **DATE-TRAP WARNING (durable): CGTLive re-datelines old news with fresh bylines** (carried "August 17, 2026" on the J&J/Sail deal that broke 07-29, and "August 14" on the 07-30 deramiocel adcomm). Always verify against the primary release. Portfolio Watch basename 2026-08-18-portfolio-watch._
